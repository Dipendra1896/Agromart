  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setPopupMessage(response.message || "Agricultural input added successfully!");
        setShowPopup(true);
      ...
      {showPopup && (
        <div style={styles.popupOverlay}>
          <div style={styles.popupContent}>
            ...
            <p style={styles.popupText}>Your agri input has been added to the marketplace.</p>
            <button 
