...
import { FaCheckCircle, FaMapMarkerAlt, FaPhone, FaMoneyBill, FaCreditCard, FaReceipt } from 'react-icons/fa';
        ...
        <div className="detail-section">
          ...
          <div className="detail-item">
            ...
            <div>
              ...
              <p>{orderDetails.paymentMethod === 'cash' ? 'Cash on Delivery' : 'Online Payment'}</p>
            </div>
          </div>
          
          {/* Show transaction ID for online payments */}
          {orderDetails.paymentMethod === 'online' && orderDetails.transactionId && (
